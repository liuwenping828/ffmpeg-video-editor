...
//        ffmpeg -y -i input.mp4 -strict experimental -vf transpose=1 -s 160x120 -r 30 -aspect 4:3 -ab 48000 -ac 2 -ar 22050 -b 2097k out.mp4

//        String[] complexCommand = {"-y", "-i", yourRealPath, "-s", "160x120", "-r", "25", "-vcodec", "mpeg4", "-b:v", "150k", "-b:a", "48000", "-ac", "2", "-ar", "22050", filePath};
        String[] complexCommand = {/*"-threads", "2",*/ "-y", "-i", yourRealPath, "-s", "544x960", "-r", "30", "-vcodec", "mpeg4", "-b:v", "150k", "-b:a", "48000", "-ac", "2", "-ar", "44100", filePath};
        execFFmpegBinary(complexCommand);
